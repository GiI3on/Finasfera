...
const FireChart = dynamic(() => import("./FireChart"), { ssr: false });
    ...
    >
      <div
        className={
          ...
          (compact
            ? " text-xs min-h-[1.4rem]"
            : " text-xs uppercase tracking-wider min-h-[1.5rem]")
        }
      >
        {label}
      </div>
      <div
        className={
          "kpi-value font-semibold text-zinc-100" +
          (compact ? " text-base mt-0.5" : " text-lg sm:text-xl mt-1")
        }
      >
        {value}
      </div>
...
/* ====== COMPONENT: SEKCJA PROMOCYJNA SKANERA AI ====== */
function AIScannerCta() {
  return (
    <section aria-label="Audyt AI portfela" className="mt-12 mb-8">
        ...
        <div className="relative bg-zinc-900/90 border border-zinc-800 rounded-2xl p-8 md:p-10 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="flex-1 text-center md:text-left">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-white tracking-tighter mb-3">
              Wykonaj{" "}
              <span className="text-amber-400">Audyt Portfela</span> w 30
              sekund
            </h2>
            <p className="text-zinc-400 text-base font-light leading-relaxed mb-0 max-w-2xl">
              Nasz model analityczny sprawdzi Twoją dywersyfikację,
              zidentyfikuje ryzyka koncentracji i zaproponuje scenariusze
              optymalizacji. Całkowicie za darmo.
            </p>
          </div>
...
/* ====== COMPONENT: SEKCJA PROMOCYJNA KALKULATORA EMERYTURY ====== */
function MonteCarloCta() {
  return (
    <section aria-label="Kalkulator emerytalny Monte Carlo" className="mt-8 mb-8">
      <div className="relative group">
        ...
        <div className="relative bg-zinc-900/90 border border-zinc-800 rounded-2xl p-8 md:p-10 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="flex-1 text-center md:text-left">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-white tracking-tighter mb-3">
              Symulator{" "}
              <span className="text-emerald-400">Bezpiecznej Emerytury</span>
            </h2>
            <p className="text-zinc-400 text-base font-light leading-relaxed mb-0 max-w-2xl">
              Zwykłe kalkulatory kłamią. Zobacz ile dokładnie otrzymasz z ZUS
              i przetestuj swój portfel inwestycyjny na historyczne krachy
              przy użyciu profesjonalnej symulacji algorytmicznej.
            </p>
          </div>
          <div className="shrink-0 w-full md:w-auto">
            <Link
...
/* ====== COMPONENT: SEKCJA PROMOCYJNA ŚLEDZENIA PORTFELA ====== */
function PortfolioTrackerCta() {
  return (
    <section aria-label="Tracker portfela inwestycyjnego" className="mt-8 mb-12">
      <div className="relative group">
        ...
        <div className="relative bg-zinc-900/90 border border-zinc-800 rounded-2xl p-8 md:p-10 flex flex-col lg:flex-row items-center justify-between gap-8">
          <div className="flex-1 text-center lg:text-left">
            ...
            <p className="text-zinc-400 text-base font-light leading-relaxed mb-6 max-w-2xl mx-auto lg:mx-0">
              Zobacz, jak radzisz sobie na tle szerokiego rynku. Podepnij
              własne ETF-y i akcje, by na bieżąco śledzić zyski, spadki i
              historyczne benchmarki.
            </p>
...
/* ====== GŁÓWNY KALKULATOR (CLIENT COMPONENT) ====== */
    ...
    <>
      {nbpError && (
        <div className="mb-4 rounded-lg border border-yellow-600/50 bg-yellow-900/20 px-4 py-3 text-sm text-yellow-200">
          Brak danych inflacji NBP — przyjmujemy <b>2.5% inflacji</b>, żeby
          nie zatrzymywać kalkulacji.
        </div>
      )}

      <section
        aria-label="Kalkulator FIRE"
        className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch auto-rows-fr"
      >
      ...
      {/* --- KALKULATOR EMERYTURY (MONTE CARLO) --- */}
      <MonteCarloCta />
