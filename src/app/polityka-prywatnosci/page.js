// src/app/polityka-prywatnosci/page.js
...
export const metadata = {
  ...
  description:
    "Polityka prywatności serwisu Finasfera.pl — informacje o przetwarzaniu danych osobowych zgodnie z RODO.",
  alternates: {
    canonical: "https://finasfera.pl/polityka-prywatnosci",
  },
  robots: {
    index: true,
    follow: false,
